...
const TransactionList = (props: { transactions?: ITransactions[] | null; onPress?: (item: ITransactions) => void }) => {
    return (
        <FlatList
...
const Item = (props: {
    ...
    const { createdAt, payment_type } = props.transaction
                ...
                <Box
                    ...
                    <Stack
                        ...
                        <Stack
                            ...
                            <Text color={'gray.400'}>{moment(createdAt).format('DD MMMM YYYY')}</Text>
                        </Stack>
                    </Stack>
                    <Stack display={'flex'}>
                        <Text
