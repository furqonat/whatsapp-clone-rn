...
const getBankCodeIcon = (bankCode: BankCode) => {
    // get bank icon by code from internet
    switch (bankCode) {
        case BankCode.harda:
            return 'https://id.wikipedia.org/wiki/Bank_Allo#/media/Berkas:Allo_Bank_logo.png'
        case BankCode.bca:
            return 'https://upload.wikimedia.org/wikipedia/commons/5/5c/Bank_Central_Asia.svg'
        case BankCode.bca_syr:
            return 'https://upload.wikimedia.org/wikipedia/commons/0/07/BCA_Syariah.svg'
        case BankCode.bjb:
            return 'https://upload.wikimedia.org/wikipedia/id/4/41/Bank_BJB_logo.svg'
        case BankCode.bjb_syr:
            return 'https://upload.wikimedia.org/wikipedia/id/0/0d/Logo-retouch.png'
        case BankCode.bri:
...
export { BankCode, getBankCodeIcon }
